...
class GruponosMeltanoPipelineRunner:
    ...
    def run_pipeline(self, job_name: str, **kwargs: Any) -> GruponosMeltanoPipelineResult:
    ...
    def _build_environment(self) -> dict[str, str]:
        ...
        if self.settings.oracle_connection.service_name:
            env["FLEXT_TARGET_ORACLE_SERVICE_NAME"] = self.settings.oracle_connection.service_name
