...
class GruponosMeltanoNativeConstants(FlextConstants):
    """GrupoNOS Meltano Native constants following FLEXT unified pattern with nested domains.

    Extends FlextConstants to inherit all base constants, adding
    GrupoNOS-specific constants in the Gruponos namespace.

    Hierarchy:
        FlextConstants (flext-core)
        └── GruponosMeltanoNativeConstants (this module)

    Access patterns:
        - c.Gruponos.* (GrupoNOS-specific constants)
        - c.Network.*, c.Errors.*, etc. (inherited from FlextConstants)
    """

    class Gruponos:
        """GrupoNOS domain-specific constants namespace."""
        ...
        class Status(StrEnum):
            ...
            DRY Pattern:
                This StrEnum is the single source of truth for pipeline status values.
                All status strings should reference Status enum members.
                Use Status.PENDING.value, Status.RUNNING.value, etc.
            """
        ...
        class DataType(StrEnum):
            ...
            DRY Pattern:
                This StrEnum is the single source of truth for data type values.
                All data type strings should reference DataType enum members.
                Use DataType.RAW.value, DataType.PROCESSED.value, etc.
            """
        ...
        class OperationType(StrEnum):
            ...
            DRY Pattern:
                This StrEnum is the single source of truth for operation type values.
                All operation type strings should reference OperationType enum members.
                Use OperationType.EXTRACT.value, OperationType.LOAD.value, etc.
            """
        ...
        class ErrorMessages:
            ...
            # Query errors
            QUERY_TIMEOUT: Final[str] = "Query execution timed out"
            QUERY_FAILED: Final[str] = "Query execution failed"
            QUERY_SYNTAX_ERROR: Final[str] = "Query syntax error"
            QUERY_PERMISSION_DENIED: Final[str] = "Query permission denied"

            # Validation errors
            VALIDATION_FAILED: Final[str] = "Data validation failed"
            VALIDATION_TIMEOUT: Final[str] = "Data validation timed out"
            VALIDATION_SCHEMA_ERROR: Final[str] = "Data validation schema error"

            # Processing errors
            PROCESSING_FAILED: Final[str] = "Data processing failed"
            PROCESSING_TIMEOUT: Final[str] = "Data processing timed out"
            PROCESSING_MEMORY_ERROR: Final[str] = "Data processing memory error"
            PROCESSING_DISK_ERROR: Final[str] = "Data processing disk error"

            # Configuration errors
            CONFIGURATION_INVALID: Final[str] = "Invalid configuration"
            CONFIGURATION_MISSING: Final[str] = "Required configuration missing"
            CONFIGURATION_TYPE_ERROR: Final[str] = "Configuration type error"

            # Permission errors
            PERMISSION_DENIED: Final[str] = "Permission denied"
            PERMISSION_INSUFFICIENT: Final[str] = "Insufficient permissions"
            PERMISSION_EXPIRED: Final[str] = "Permissions expired"

            # Resource errors
            RESOURCE_NOT_FOUND: Final[str] = "Resource not found"
            RESOURCE_UNAVAILABLE: Final[str] = "Resource unavailable"
            RESOURCE_LOCKED: Final[str] = "Resource locked"
            RESOURCE_EXHAUSTED: Final[str] = "Resource exhausted"

            # General errors
            UNKNOWN_ERROR: Final[str] = "Unknown error occurred"
            INTERNAL_ERROR: Final[str] = "Internal error occurred"
...
c = GruponosMeltanoNativeConstants

__all__ = ["GruponosMeltanoNativeConstants", "c"]
