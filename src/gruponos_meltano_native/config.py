...
class WMSSourceConfig(BaseConfig):
    ...
    api_base_url: str | None = Field(None, description="WMS API base URL")
    api_username: str | None = Field(None, description="WMS API username")
    api_password: str | None = Field(None, description="WMS API password", repr=False)
