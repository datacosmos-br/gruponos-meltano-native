...
def load_project_config() -> dict[str, t.GeneralValueType]:
...
def load_wms_config() -> dict[str, t.GeneralValueType]:
...
def generate_meltano_config() -> dict[str, t.GeneralValueType]:
