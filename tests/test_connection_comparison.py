...
from flext_observability.logging import setup_logging, get_logger

# Import both implementations
from oracle.connection_manager import OracleConnectionManager as OriginalManager
from oracle.connection_manager import create_connection_manager_from_env as create_original
from oracle.connection_manager_enhanced import OracleConnectionManager as EnhancedManager
from oracle.connection_manager_enhanced import create_connection_manager_from_env as create_enhanced
...
def simulate_connection_failure():
    ...
    try:
        ...
        try:
            ...
            logger.error(f"Failed as expected: {e}")
